...
export const Featured = () => {
  const { data, loading, error } = useFetch(
    "http://localhost:8070/api/hotels/countByCity?cities=Kandy,Galle,Colombo,Anuradhapura,Jaffna"
  );

  return (
    <>
    <div className="subTitle">Browse our most popular travel Destinations</div>
